...
public class Adapter_User_Current_Orders extends ArrayAdapter<String> {

        Context mContext;
        int mLayoutResId;
        String mData[] = null;

        public Adapter_User_Current_Orders(Context context, int resource, String[] objects) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Adapter_User_Current_Orders.PlaceHolder holder = null;
            ...
            if(row == null){
                ...
                holder = new Adapter_User_Current_Orders.PlaceHolder();
                ...
                holder = (Adapter_User_Current_Orders.PlaceHolder) row.getTag();
            }
